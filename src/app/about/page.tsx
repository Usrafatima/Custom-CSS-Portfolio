  ...
  return (
    <div>
      ...
      <p className="design-para">
        ...
        collaboratively, consulting with you throughout the process. With my skills and dedication,<br /> I’ll create a
        user-friendly, visually appealing website that reflects your brand and drives results
      </p>
      ...
      <p className="develop-para">
        ...
        features that enhance functionality and user engagement. From front-end <br />
        design to back-end integration, I ensure your website is optimized, secure, and aligned <br />
        with industry best practices to support your business goals..
      </p>
      ...
      <p className="maint-para">
        ...
        your website stays responsive and performs at its best. I’m available to address any issues promptly,<br /> make
